    ...
    <div className={cardClasses} onClick={handleCardClick}>
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <h3 className="text-lg font-medium text-gray-900 truncate">{testCase.name}</h3>
          {testCase.description && (
            <p className="mt-1 text-sm text-gray-600 line-clamp-2">{testCase.description}</p>
          )}
        </div>
            ...
            <div className="flex items-center">
              <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.586a1 1 0 01.707.293l4.828 4.829a2 2 0 002.828 0 2 2 0 000-2.829L14.121 7.464A1 1 0 0013.414 7H9a3 3 0 00-3 3v4a3 3 0 003 3z"
                />
              </svg>
      ...
      <div className="mt-3 flex items-center justify-between text-xs text-gray-400">
        <div className="flex items-center space-x-4">
          {testCase.category && <span>Category: {testCase.category}</span>}
          {testCase.author && <span>By: {testCase.author}</span>}
        </div>
